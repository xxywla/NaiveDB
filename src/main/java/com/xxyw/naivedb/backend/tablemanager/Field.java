...
import com.xxyw.naivedb.backend.indexmanager.BPlusTree;
import com.xxyw.naivedb.backend.parser.statement.SingleExpression;
...
/**
 * @author Youjing Ju
 * @create 2023-05-09 19:04
 */
/*
field 表示字段信息
[FieldName][TypeName][IndexUid]
TypeName 为字段的类型，限定为 int32、int64 和 string 类型。
FieldName 和 TypeName 格式如下
...
public class Field {
    ...
    private static void typeCheck(String fieldType) throws Exception {
        if (!"int32".equals(fieldType) && !"int64".equals(fieldType) && !"string".equals(fieldType)) {
            throw MyError.InvalidFieldException;
        }
    }
